...
class PopUpWindowCreateUpdateMixin(object):
    ...
    def get_context_data(self, **kwargs):
        ...
        if (RelatedFieldWidgetWrapper.TO_FIELD_VAR in self.request.GET
                or RelatedFieldWidgetWrapper.TO_FIELD_VAR in self.request.POST):
        ...
        if (RelatedFieldWidgetWrapper.IS_POPUP_VAR in self.request.GET
                or RelatedFieldWidgetWrapper.IS_POPUP_VAR in self.request.POST):
