from oscar.apps.catalogue.reviews.abstract_models import (
    AbstractProductReview, AbstractProductReviewImage, AbstractVote)
...
if not is_model_registered('reviews', 'ProductReviewImage'):
    class ProductReviewImage(AbstractProductReviewImage):
        pass
